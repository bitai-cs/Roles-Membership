...
namespace AzManWebApiClientHelpers {
	public class AzManItemsHelper<BSO> : BaseHelper<BSO> {
		public AzManItemsHelper() : base()
		{
		}

		public AzManItemsHelper(string webApiUri) : base(webApiUri) {
		}

		public async Task<Dictionary<string, IEnumerable<object>>> GetItemByNameAsync(string item, string store, string application, bool loadAttributes, bool loadMembers, bool loadItemsWhereIAmAMember, bool loadAuthorizations) {
		...
		public async Task<Dictionary<string, IEnumerable<object>>> GetItemsAsync(string store, string application, NetSqlAzMan.ServiceBusinessObjects.ItemType itemType, bool loadAttributes, bool loadMembers, bool loadItemsWhereIAmAMember, bool loadAuthorizations) {
		...
		public async Task<Dictionary<string, IEnumerable<object>>> PostItemAsync(string store, string application, BSO bso) {
		...
		public async Task<Dictionary<string, IEnumerable<object>>> PutItemAsync(string item, string store, string application, BSO modifiedItem) {
		...
		public async Task<Dictionary<string, IEnumerable<object>>> DeleteItemAsync(string id, string store, string application) {
