...
namespace AzManWebApiClientHelpers
{
	...
	{
		public AzManStorageAuthorizationsHelper() : base()
		{
		}

		public AzManStorageAuthorizationsHelper(string webApiUri) : base(webApiUri) {
		}

		public async Task<Dictionary<string, IEnumerable<object>>> CheckAccessAsync(string store, string application, string item, string domainProfile, string userName, Nullable<DateTime> validFor = null, Nullable<bool> operationsOnly = false, IEnumerable<KeyValuePair<string, object>> contextParameters = null) {
