...
namespace AzManWebServices
{
	...
	public class CacheService : ICacheService
	{
				...
				if (!CacheService.buildingCache) {
					...
					if (AsyncCacheBuilding) {
						System.Threading.ThreadPool.QueueUserWorkItem(new System.Threading.WaitCallback(o => {
							try {
								StorageCache sc = new StorageCache(ConfigurationManager.ConnectionStrings["NetSqlAzManStorageCacheConnectionString"].ConnectionString);
		...
		/// <summary>
		/// Invalidar Cache de NetSqlAzMan
		/// </summary>
		...
		/// Invalidar Cache de NetSqlAzMan
		/// </summary>
		/// <param name="invalidateCacheOnServicePartners">Tambien en los otros serivicios registrados en la configuracion</param>
		...
		/// Invalidar Cache de NetSqlAzMan
		/// </summary>
		/// <param name="storeName">Nombre del Store para invalidar</param>
		...
		/// Invalidar Cache de NetSqlAzMan
		/// </summary>
		/// <param name="storeName">Nombre del Store</param>
		/// <param name="applicationName">Nombre del Application</param>
