...
{
	public partial class LoginBlUI : BorderlessForm
	{
		...
		#region Constructors
		public LoginBlUI(string clientApplication, string azMan_Store, string azMan_Application, string azMan_ItemName, string userName, string password)
			: base() {
			InitializeComponent();
		...
		private void LoginUI_Load(object sender, EventArgs e) {
			picbLogo.MouseDown += control_MouseDown;
			picbLogo.MouseMove += control_MouseMove;
			picbLogo.MouseUp += control_MouseUp;
#if DEBUG
		...
		private void bbitExit_ItemClick(object sender, EventArgs e) {
			this.DialogResult = System.Windows.Forms.DialogResult.Cancel;
		}

		private void iExit_ItemClick(object sender, EventArgs e) {
			this.DialogResult = System.Windows.Forms.DialogResult.Cancel;
		}

		private void bbitLoginOpenConfig_ItemClick(object sender, EventArgs e) {
