namespace AzManLoginWinFormsTest
{
	partial class TestUi
	{
		...
		private void InitializeComponent() {
			...
			this.lablBranch = new DevExpress.XtraEditors.LabelControl();
			this.simpleButton2 = new DevExpress.XtraEditors.SimpleButton();
			this.simpleButton1 = new DevExpress.XtraEditors.SimpleButton();
			this.labelControl3 = new DevExpress.XtraEditors.LabelControl();
			this.combItem = new DevExpress.XtraEditors.ComboBoxEdit();
			...
			this.combApplication = new DevExpress.XtraEditors.ComboBoxEdit();
			this.labelControl1 = new DevExpress.XtraEditors.LabelControl();
			this.combStore = new DevExpress.XtraEditors.ComboBoxEdit();
			...
			((System.ComponentModel.ISupportInitialize)(this.combItem.Properties)).BeginInit();
			...
			((System.ComponentModel.ISupportInitialize)(this.combApplication.Properties)).BeginInit();
			((System.ComponentModel.ISupportInitialize)(this.combStore.Properties)).BeginInit();
			...
			this.splitContainerControl.Panel2.Controls.Add(this.lablBranch);
			...
			this.splitContainerControl.Panel2.Controls.Add(this.combItem);
			this.splitContainerControl.Panel2.Controls.Add(this.labelControl2);
			this.splitContainerControl.Panel2.Controls.Add(this.combApplication);
			this.splitContainerControl.Panel2.Controls.Add(this.labelControl1);
			this.splitContainerControl.Panel2.Controls.Add(this.combStore);
			this.splitContainerControl.Panel2.Controls.Add(this.gridControl);
			this.splitContainerControl.Panel2.Text = "Panel2";
			this.splitContainerControl.Size = new System.Drawing.Size(712, 288);
			this.splitContainerControl.SplitterPosition = 83;
			...
			this.navBarControl.OptionsNavPane.ExpandedWidth = 83;
			this.navBarControl.PaintStyleKind = DevExpress.XtraNavBar.NavBarViewKind.ExplorerBar;
			this.navBarControl.Size = new System.Drawing.Size(83, 276);
			...
			// lablBranch
			// 
			this.lablBranch.Location = new System.Drawing.Point(174, 238);
			this.lablBranch.Name = "lablBranch";
			this.lablBranch.Size = new System.Drawing.Size(10, 13);
			this.lablBranch.TabIndex = 9;
			this.lablBranch.Text = "¿?";
			// 
			// simpleButton2
			// 
			this.simpleButton2.Location = new System.Drawing.Point(0, 233);
			this.simpleButton2.Name = "simpleButton2";
			this.simpleButton2.Size = new System.Drawing.Size(163, 21);
			this.simpleButton2.TabIndex = 8;
			this.simpleButton2.Text = "Seleccionar SEDE del Usuario";
			this.simpleButton2.Click += new System.EventHandler(this.simpleButton2_Click);
			// 
			// simpleButton1
			// 
			this.simpleButton1.Location = new System.Drawing.Point(507, 8);
			this.simpleButton1.Name = "simpleButton1";
			this.simpleButton1.Size = new System.Drawing.Size(102, 21);
			...
			this.labelControl3.Size = new System.Drawing.Size(32, 26);
			this.labelControl3.TabIndex = 6;
			this.labelControl3.Text = "AzMan\r\nItem:";
			// 
			// combItem
			// 
			this.combItem.Location = new System.Drawing.Point(369, 9);
			this.combItem.MenuManager = this.ribbonControl;
			this.combItem.Name = "combItem";
			this.combItem.Properties.AutoComplete = false;
			this.combItem.Properties.Buttons.AddRange(new DevExpress.XtraEditors.Controls.EditorButton[] {
            new DevExpress.XtraEditors.Controls.EditorButton(DevExpress.XtraEditors.Controls.ButtonPredefines.Combo)});
			this.combItem.Properties.TextEditStyle = DevExpress.XtraEditors.Controls.TextEditStyles.DisableTextEditor;
			this.combItem.Size = new System.Drawing.Size(129, 20);
			this.combItem.TabIndex = 5;
			// 
			// ribbonControl
			// 
			...
			this.ribbonControl.Size = new System.Drawing.Size(712, 143);
			...
			this.ribbonStatusBar.Size = new System.Drawing.Size(712, 31);
			// 
			// labelControl2
			// 
			this.labelControl2.Location = new System.Drawing.Point(128, 3);
			this.labelControl2.Name = "labelControl2";
			this.labelControl2.Size = new System.Drawing.Size(56, 26);
			this.labelControl2.TabIndex = 4;
			this.labelControl2.Text = "AzMan\r\nApplication:";
			// 
			// combApplication
			// 
			this.combApplication.Location = new System.Drawing.Point(190, 9);
			this.combApplication.MenuManager = this.ribbonControl;
			this.combApplication.Name = "combApplication";
			this.combApplication.Properties.AutoComplete = false;
			this.combApplication.Properties.Buttons.AddRange(new DevExpress.XtraEditors.Controls.EditorButton[] {
            new DevExpress.XtraEditors.Controls.EditorButton(DevExpress.XtraEditors.Controls.ButtonPredefines.Combo)});
			this.combApplication.Properties.TextEditStyle = DevExpress.XtraEditors.Controls.TextEditStyles.DisableTextEditor;
			this.combApplication.Size = new System.Drawing.Size(129, 20);
			this.combApplication.TabIndex = 3;
			// 
			// labelControl1
			// 
			...
			this.labelControl1.Text = "AzMan\r\nStore:";
			// 
			// combStore
			// 
			this.combStore.Location = new System.Drawing.Point(40, 9);
			this.combStore.MenuManager = this.ribbonControl;
			this.combStore.Name = "combStore";
			this.combStore.Properties.AutoComplete = false;
			this.combStore.Properties.Buttons.AddRange(new DevExpress.XtraEditors.Controls.EditorButton[] {
            new DevExpress.XtraEditors.Controls.EditorButton(DevExpress.XtraEditors.Controls.ButtonPredefines.Combo)});
			this.combStore.Properties.TextEditStyle = DevExpress.XtraEditors.Controls.TextEditStyles.DisableTextEditor;
			this.combStore.Size = new System.Drawing.Size(78, 20);
			this.combStore.TabIndex = 1;
			// 
			// gridControl
			// 
			...
			this.gridControl.Size = new System.Drawing.Size(609, 183);
			...
			((System.ComponentModel.ISupportInitialize)(this.combItem.Properties)).EndInit();
			...
			((System.ComponentModel.ISupportInitialize)(this.combApplication.Properties)).EndInit();
			((System.ComponentModel.ISupportInitialize)(this.combStore.Properties)).EndInit();
		...
		private DevExpress.XtraEditors.ComboBoxEdit combStore;
		private DevExpress.XtraEditors.LabelControl labelControl3;
		private DevExpress.XtraEditors.ComboBoxEdit combItem;
		private DevExpress.XtraEditors.LabelControl labelControl2;
		private DevExpress.XtraEditors.ComboBoxEdit combApplication;
		private DevExpress.XtraEditors.LabelControl labelControl1;
		private DevExpress.XtraEditors.SimpleButton simpleButton1;
		private DevExpress.XtraEditors.SimpleButton simpleButton2;
		private DevExpress.XtraEditors.LabelControl lablBranch;
