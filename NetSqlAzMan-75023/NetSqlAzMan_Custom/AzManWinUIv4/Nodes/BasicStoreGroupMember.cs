...
namespace AzManWinUI.Nodes
{
	public class BasicStoreGroupMemberNode :Basgosoft.ManagementConsoleLib.BaseNode
	{
		...
		protected override void renderNode() {
			...
			#region Call WebApi
			var _h = new WebApiClientHelpers.AzManStoreGroupMembersHelper<NetSqlAzMan.ServiceBusinessObjects.AzManStoreGroupMemberDisplayInfo>(_webApiUri);
			...
			switch (memberType) {
				...
				case NetSqlAzMan.ServiceBusinessObjects.MemberType.StoreGroup:
					...
					var _sgh = new WebApiClientHelpers.AzManStoreGroupsHelper<NetSqlAzMan.ServiceBusinessObjects.AzManStoreGroup>(_webApiUri);
