...
{
	public partial class frmCheckAccessTestOld :frmBase
	{
		...
		private void RefreshItemsHierarchy() {
			frmItemsHierarchyView ihv = new frmItemsHierarchyView("????????", null);
			this.DialogResult = DialogResult.None;
			ImageList clonedImageList = new ImageList();
			...
			//VBASTIDAS: Se comentó solo para poder compilar
