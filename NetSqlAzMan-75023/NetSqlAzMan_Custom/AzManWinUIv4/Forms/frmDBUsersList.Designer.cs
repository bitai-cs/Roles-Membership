namespace NetSqlAzMan.SnapIn.Forms
{
    partial class frmDBUsersList
    {
        ...
        private void InitializeComponent()
        {
			...
			this.customSidColumnHeader = ((System.Windows.Forms.ColumnHeader)(new System.Windows.Forms.ColumnHeader()));
			this.typeHeader1 = ((System.Windows.Forms.ColumnHeader)(new System.Windows.Forms.ColumnHeader()));
			...
			this.lblNote.Text = "Note: to change DB Users list, modify \"dbo.netsqlazman_GetDBUsers\" table-function" +
    " on NetSqlAzManStorage DB.";
			// 
			// lblFilter
			// 
