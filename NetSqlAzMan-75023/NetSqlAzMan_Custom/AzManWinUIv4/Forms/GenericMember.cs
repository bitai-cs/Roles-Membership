...
namespace NetSqlAzMan.SnapIn.Forms
{
	internal class GenericMember
	{
		...
		internal string LDAPDomain;

		internal GenericMember(IAzManSid sid, WhereDefined whereDefined, string ldapDomain, AuthorizationType authorizationType, DateTime? validFrom, DateTime? validTo) {
			this.sid = sid;
			this.WhereDefined = whereDefined;
			this.authorizationType = authorizationType;
			this.validFrom = validFrom;
		...
		internal GenericMember(string name, IAzManSid sid, WhereDefined whereDefined, string ldapDomain)
