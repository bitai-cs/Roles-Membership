...
namespace NetSqlAzMan.SnapIn.Forms {
	public partial class frmImport : frmBase {
		...
		private bool checkScopeNodePosition(XmlDocument doc, ref object objectForImport, out XmlNode xmlStartNode) {
			...
			else if (objectForImport as AzManWinUI.Nodes.StoreGroupsNode != null) {
				firstChildNodeNameMustBe = "StoreGroup";
				firstChildNodeNameMustBeOr = "StoreGroups";
				objectForImport = ((AzManWinUI.Nodes.StoreGroupsNode)objectForImport).Store;
			}
			...
			else if (objectForImport as AzManWinUI.Nodes.ApplicationGroupsNode != null) {
				firstChildNodeNameMustBe = "ApplicationGroup";
				firstChildNodeNameMustBeOr = "ApplicationGroups";
				objectForImport = ((AzManWinUI.Nodes.ApplicationGroupsNode)objectForImport).Application;
			}
			else if (objectForImport as AzManWinUI.Nodes.ItemDefinitionsNode != null) {
				firstChildNodeNameMustBe = "Item";
				firstChildNodeNameMustBeOr = "Items";
				objectForImport = ((AzManWinUI.Nodes.ItemDefinitionsNode)objectForImport).Application;
			}
			else if (objectForImport as AzManWinUI.Nodes.ItemDefinitionNode != null) {
				firstChildNodeNameMustBe = "Item";
				firstChildNodeNameMustBeOr = "Items";
				objectForImport = ((AzManWinUI.Nodes.ItemDefinitionNode)objectForImport).Item;
			}
			else
				throw new ArgumentException("objectForImport type not supported.");
		...
		private IAzManStorage getStorageReference(object objectForImport) {
			...
			else if (objectForImport as AzManWinUI.Nodes.StoreGroupsNode != null) //(objectForImport as StoreGroupsScopeNode != null)
				return ((AzManWinUI.Nodes.StoreGroupsNode)objectForImport).Store.Storage;
			else if (objectForImport as IAzManApplication != null)
			...
			//   return ((ItemDefinitionScopeNode)objectForImport).Item.Application.Store.Storage;
				...
				throw new ArgumentException(Globalization.MultilanguageResource.GetString("frmImport_Msg20"));
		}
