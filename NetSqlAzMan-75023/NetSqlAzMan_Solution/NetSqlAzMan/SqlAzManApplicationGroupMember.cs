				...
				switch (this.whereDefined) {
					...
					case WhereDefined.LDAP:
						...
						if (!string.IsNullOrEmpty(this.LDAPDomain)) {
							string _endPoint = LDAPServices.LDAPConfigUtils.GetWebSvcEndpointByDomainProfile(this.ApplicationGroup.Application.Store.Storage.ConnectionString, this.LDAPDomain);
