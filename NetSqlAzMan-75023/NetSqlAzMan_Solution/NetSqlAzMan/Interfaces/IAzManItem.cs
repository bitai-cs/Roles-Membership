...
namespace NetSqlAzMan.Interfaces {
	...
	public partial interface IAzManItem : IAzManExport, IAzManImport, IDisposable {
		/// <summary>
		...
		[DataMember]
		BizRuleSourceLanguage? BizRuleSourceLanguage {
			get;
		}
		/// <summary>
		...
		[DataMember]
		Dictionary<string, IAzManItem> Members {
			get;
		}
		/// <summary>
		/// Gets the items where I am A member.
		...
		[DataMember]
		Dictionary<string, IAzManItem> ItemsWhereIAmAMember {
			get;
		}
		/// <summary>
		/// Gets the attributes.
		...
		[DataMember]
		Dictionary<string, IAzManAttribute<IAzManItem>> Attributes {
			get;
		}
		/// <summary>
		...
		[DataMember]
		System.Collections.ObjectModel.ReadOnlyCollection<IAzManAuthorization> Authorizations {
			get;
		}
		/// <summary>
		/// Gets the authorizations.
		...
		/// <value></value>
		[DataMember]
		IAzManAuthorization[] this[IAzManSid owner, IAzManSid sid] {
			get;
		}
		/// <summary>
