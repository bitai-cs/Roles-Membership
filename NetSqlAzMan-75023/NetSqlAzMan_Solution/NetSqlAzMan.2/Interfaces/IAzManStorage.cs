...
namespace NetSqlAzMan.Interfaces
{
	...
	public partial interface IAzManStorage : IAzManExport, IAzManImport, IAzManTransactable, IDisposable
	{
		/// <summary>
		...
		/// <value></value>
		[DataMember]
		IAzManStore this[string storeName] {
			get;
		}
		/// <summary>
		/// Gets the stores.
		...
		[DataMember]
		Dictionary<string, IAzManStore> Stores {
			get;
		}
		/// <summary>
		...
		[DataMember]
		Dictionary<string, IAzManDBUser> DBUsers {
			get;
		}
		/// <summary>
		/// Gets the mode.
		...
		[DataMember]
		System.IO.TextWriter LogStream {
			get;
			set;
		}
		/// <summary>
