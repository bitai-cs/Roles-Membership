...
namespace NetSqlAzMan.Interfaces
{
	...
	public partial interface IAzManAuthorization : IAzManExport, IAzManImport, IDisposable
	{
		/// <summary>
		...
		int AuthorizationId {
			get;
		} //da implementare esplicitamente
		/// <summary>
		/// Gets the itemName.
		/// </summary>
		...
		[DataMember]
		Dictionary<string, IAzManAttribute<IAzManAuthorization>> Attributes {
			get;
		}
		/// <summary>
		/// Gets the attribute.
