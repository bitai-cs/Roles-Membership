...
namespace NetSqlAzMan
{
	...
	public class SqlAzManException :System.Exception, ISerializable
	{
		...
		internal static SqlAzManException AuthenticationException(string userName, Exception innerException) {
			SqlAzManException ex = new SqlAzManException("Usuario y/o contraseña incorrecta.", innerException);
			return ex;
		}		
