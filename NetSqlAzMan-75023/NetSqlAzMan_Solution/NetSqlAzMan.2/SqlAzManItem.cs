    ...
    public sealed partial class SqlAzManItem :IAzManItem
    {
        ...
        public Assembly LoadBizRuleAssembly() {
            ...
            if (cachedBizRule == null) {
                var item = (from t in this.db.Items()
                            where t.ItemId == this.itemId
        ...
        public void ClearBizRule() {
            ...
            try {
                ...
                if (txBeginned)
                    ((SqlAzManStorage)(this.application.Store.Storage)).internalCommitTransaction();
            }
            catch {
                if (txBeginned)
                    ((SqlAzManStorage)(this.application.Store.Storage)).internalRollBackTransaction();
                throw;
            }
        }
        ...
        public IAzManAuthorization GetAuthorization(int authorizationId) {
            ...
            if ((ar = (from t in this.db.Authorizations()
                       where t.ItemId == this.itemId && t.AuthorizationId == authorizationId
                ...
                if (this.application.Store.Storage.Mode == NetSqlAzManMode.Administrator && ar.ObjectSidWhereDefined == (byte)WhereDefined.Local) {
                    ...
                    IAzManAuthorization result = new SqlAzManAuthorization(this.db, this, ar.AuthorizationId.Value, new SqlAzManSID(ar.OwnerSid.ToArray(), ar.OwnerSidWhereDefined == (byte)(WhereDefined.Database)), (WhereDefined)ar.OwnerSidWhereDefined, new SqlAzManSID(ar.ObjectSid.ToArray(), ar.ObjectSidWhereDefined == (byte)(WhereDefined.Database)), (WhereDefined)(ar.ObjectSidWhereDefined), ar.DomainProfile, ar.samAccountName, ar.cn, ar.displayName, ar.objectSidString, ar.distinguishedName, ar.objectClass, (AuthorizationType)ar.AuthorizationType, ar.ValidFrom, ar.ValidTo, this.ens);
                    if (this.ens != null)
                        this.ens.AddPublisher(result);
                    return result;
                }
        ...
        public IAzManAuthorization[] this[IAzManSid owner, IAzManSid sid] {
            get {
                return this.GetAuthorizations(owner, sid);
            }
        }
        /// <summary>
        ...
        public IAzManAttribute<IAzManItem> GetAttribute(string key) {
            ...
            if ((iar = (from t in this.db.ItemAttributes()
                        where t.ItemId == this.itemId && t.AttributeKey == key
                        select t).FirstOrDefault()) != null) {
                        ...
                        if (childNode.Name == "Authorization") {
                            ...
                            switch (childNode.Attributes["SidWhereDefined"].Value) {
                                case "Application":
                                    ...
                                    break;
                                case "LDAP":
                                    sidWhereDefined = WhereDefined.LDAP;
                                    break;
                                case "Local":
                                ...
                                case "Store":
                                    ...
                                    break;
                                case "Database":
                                    sidWhereDefined = WhereDefined.Database;
                                    break;
                                default:
                            ...
                            switch (childNode.Attributes["OwnerSidWhereDefined"].Value) {
                                case "Application":
                                    ownerSidWhereDefined = WhereDefined.Application;
                                    break;
                                case "LDAP":
                                    ownerSidWhereDefined = WhereDefined.LDAP;
                                    break;
                                case "Local":
                                    ownerSidWhereDefined = WhereDefined.Local;
                                    break;
                                case "Store":
                                    ownerSidWhereDefined = WhereDefined.Store;
                                    break;
                                case "Database":
                                    ownerSidWhereDefined = WhereDefined.Database;
                                    break;
                                default:
                            ...
                            switch (childNode.Attributes["AuthorizationType"].Value) {
                                case "Allow":
                                    ...
                                    break;
                                case "AllowWithDelegation":
                                    authorizationType = AuthorizationType.AllowWithDelegation;
                                    break;
                                case "Deny":
                                    authorizationType = AuthorizationType.Deny;
                                    break;
                                case "Neutral":
