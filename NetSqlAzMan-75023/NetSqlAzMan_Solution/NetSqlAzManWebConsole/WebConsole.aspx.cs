...
namespace NetSqlAzManWebConsole
{
	public partial class WebConsole : ThemePage
	{
		...
		protected void Page_Init(object sender, EventArgs e) {
			...
			switch (this.Theme) {
				//case "Default":
				//   this.imgLogo2.ImageUrl = "~/Images/logo.gif";
				//   break;
				//case "Green":
				//   this.imgLogo2.ImageUrl = "~/Images/logo_1.gif";
				//   break;
				//case "Yellow":
				//   this.imgLogo2.ImageUrl = "~/Images/logo_2.gif";
				//   break;
				case "Default":
					this.imgLogo2.ImageUrl = "";
					break;
				case "Green":
					this.imgLogo2.ImageUrl = "~/Images/logo_1.gif";
					break;
			...
			try {
				...
				if (nodeValue.StartsWith("Storage|")) {
					foreach (IAzManStore store in this.Storage.GetStores()) {
						...
						else if (store.IAmManager)
							fixedserverrole = "Manager";
						else if (store.IAmUser)
		...
		private void deleteSelectedObject() {
			try {
				if (this.SelectedObject as IAzManStore != null)
					((IAzManStore)this.SelectedObject).Delete();
				else if (this.SelectedObject as IAzManStoreGroup != null)
					((IAzManStoreGroup)this.SelectedObject).Delete();
				else if (this.SelectedObject as IAzManApplication != null)
					((IAzManApplication)this.SelectedObject).Delete();
				else if (this.SelectedObject as IAzManApplicationGroup != null)
					((IAzManApplicationGroup)this.SelectedObject).Delete();
						...
						foreach (IAzManStoreGroupMember member in group.GetStoreGroupAllMembers()) {
							...
							switch (memberType) {
								...
								case MemberType.WindowsNTGroup:
									image = "WindowsBasicGroup_16x16.gif";
									break;
								case MemberType.WindowsNTUser:
									image = "WindowsUser_16x16.gif";
									break;
								case MemberType.DatabaseUser:
									image = "DBUser_16x16.gif";
									break;
								case MemberType.AnonymousSID:
								default:
									image = "SIDNotFound_16x16.gif";
									break;
							}
				...
				//Role Definition
					...
					foreach (IAzManItem member in item.GetMembers()) {
						...
						switch (member.ItemType) {
							case ItemType.Role:
								image = "Role_16x16.gif";
								break;
							case ItemType.Task:
								image = "Task_16x16.gif";
								break;
							case ItemType.Operation:
								image = "Operation_16x16.gif";
								break;
						}
					...
					foreach (IAzManAuthorization authorization in item.GetAuthorizations()) {
						...
						switch (authorization.AuthorizationType) {
							...
							case AuthorizationType.AllowWithDelegation:
								sAuthType = "Allow With Delegation";
								break;
						...
						switch (authorization.SidWhereDefined.ToString()) {
							case "LDAP":
								sidWDS = "Active Directory";
								break;
							case "Local":
								sidWDS = "Local Computer";
								break;
							case "Database":
								sidWDS = "Database";
								break;
					...
					if (menuItem.Text != "-") {
						...
						switch (menuItem.Text) {
							case "Storage connection":
								mi.ImageUrl = this.getImageUrl("db.gif");
								break;
							case "Options":
								mi.ImageUrl = this.getImageUrl("Options_16x16.gif");
								break;
							case "Invalidate WCF Cache Service":
								mi.ImageUrl = this.getImageUrl("Cache_16x16.gif");
								break;
							case "New Store":
							...
							case "New Task":
							case "New Operation":
								mi.ImageUrl = this.getImageUrl("new.gif");
								break;
							case "Import Store from AzMan":
								mi.ImageUrl = this.getImageUrl("azman.gif");
								break;
							case "Import Stores":
							...
							case "Import Items":
								mi.ImageUrl = this.getImageUrl("import.gif");
								break;
							case "Export Stores":
							case "Export Store":
							...
							case "Export Items":
								mi.ImageUrl = this.getImageUrl("export.gif");
								break;
							case "Refresh":
								mi.ImageUrl = this.getImageUrl("refresh.gif");
								break;
							case "Store Properties":
								mi.ImageUrl = this.getImageUrl("Store_16x16.gif");
								break;
							case "Items Hierarchical View":
							case "Items Hierarchy":
								mi.ImageUrl = this.getImageUrl("Hierarchy_16x16.gif");
								break;
							case "Reports":
								mi.ImageUrl = this.getImageUrl("print.gif");
								break;
							case "Delete":
								mi.ImageUrl = this.getImageUrl("delete.gif");
								break;
							case "Items Authorizations":
								mi.ImageUrl = this.getImageUrl("ItemAuthorization_16x16.gif");
								break;
							case "Mode and Logging":
								mi.ImageUrl = this.getImageUrl("NetSqlAzMan_16x16.gif");
								break;
							case "Auditing":
								mi.ImageUrl = this.getImageUrl("SqlAudit_16x16.gif");
								break;
							case "Application Properties":
								mi.ImageUrl = this.getImageUrl("Application_16x16.gif");
								break;
							case "Generate CheckAccessHelper":
								mi.ImageUrl = this.getImageUrl("vsnet_16x16.gif");
								break;
							case "Check Access Test":
								mi.ImageUrl = this.getImageUrl("CheckAccessTest_16x16.gif");
								break;
							case "Application Group Properties":
							case "Store Group Properties":
								mi.ImageUrl = this.getImageUrl("StoreApplicationGroup_16x16.gif");
								break;
							case "Role Properties":
								mi.ImageUrl = this.getImageUrl("Role_16x16.gif");
								break;
							case "Task Properties":
								mi.ImageUrl = this.getImageUrl("Task_16x16.gif");
								break;
							case "Operation Properties":
								mi.ImageUrl = this.getImageUrl("Operation_16x16.gif");
								break;
							case "Effective Permissions":
								mi.ImageUrl = this.getImageUrl("EffectivePermissions_16x16.gif");
								break;
							case "Manage Authorizations":
								mi.ImageUrl = this.getImageUrl("ItemAuthorization_16x16.gif");
								break;
							default:
								mi.ImageUrl = this.getImageUrl("blank.gif");
								break;
						}
						mic.Add(mi);
				...
				for (int c = 1; c < values.Length; c++) {
					...
					if (c == 1) {
						...
						switch ((string)values[0]) {
							case "Application_16x16.gif":
								toolTip = "Application";
								break;
							case "DBUser_16x16.gif":
								toolTip = "Database User";
								break;
							case "Folder_16x16.gif":
								toolTip = "Container";
								break;
							case "Operation_16x16.gif":
								toolTip = "Operation";
								break;
							case "Role_16x16.gif":
								toolTip = "Role";
							...
							case "Task_16x16.gif":
								toolTip = "Task";
								break;
							case "SIDNotFound_16x16.gif":
								toolTip = "SID not found";
								break;
							case "Store_16x16.gif":
								toolTip = "Store";
								break;
							case "StoreApplicationGroup_16x16.gif":
								toolTip = "Group";
								break;
							case "WindowsBasicGroup_16x16.gif":
								toolTip = "Windows Basic Group";
								break;
							case "WindowsQueryLDAPGroup_16x16.gif":
								toolTip = "Windows LDAP Group";
								break;
							case "WindowsUser_16x16.gif":
								toolTip = "Windows User";
								break;
						}
