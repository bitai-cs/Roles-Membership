			...
			<asp:Panel ID="Panel1" runat="server" Height="50px" Width="572px" GroupingText="Storage Connection" DefaultButton="btnOk">
				<table>
					...
					<tr>
						...
						<td style="width: 1070px">
							<asp:RadioButton ID="rbIntegrated" runat="server" Text="Integrated" TabIndex="5" AutoPostBack="True" GroupName="Authentication" OnCheckedChanged="rbAuthentication_CheckedChanged" />
							<asp:RadioButton ID="rbSql" runat="server" Text="Sql" TabIndex="6" AutoPostBack="True" GroupName="Authentication" OnCheckedChanged="rbAuthentication_CheckedChanged" Checked="True" /></td>
					</tr>
					<tr>
						<td style="width: 389px">
